...
class Triangle:
    ...
    def __init__(self, x1, y1, x2, y2, x3, y3):
        #zabezpiecznie przed sytuacją, gdy punkty są współliniowe
        #Wykorzystać wyjątek ValueError do obsługi błędów (napisać funkcję pomocniczą?)
    ...
    def make4(self): pass #zwraca krotkę 4 mniejszych po podziale
